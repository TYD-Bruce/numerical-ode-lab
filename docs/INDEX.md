...
traceability. Group A ready records `COPY-001`, `COPY-002`, `COPY-004`, and
`COPY-005` are implemented and locally verified; `COPY-003` remains held.
Group B and production Glossary content remain unauthorized.
...
unauthorized production content wave. Group A visible-copy implementation is
locally complete and awaiting maintainer acceptance. Production Glossary
content and later copy groups remain unauthorized.
...
| [Project Copy Audit](content/PROJECT_COPY_AUDIT.md) | Reconciled 55-record audit with exact replacement copy and source/test/browser traceability; four Group A ready records implemented locally and `COPY-003` held |
...
| [Project Language v1 Handoff](content/HANDOFF.md) | Approved choices, counts, Group A implementation evidence, held scope, and next gate |
...
- [Numerical T-Lab project-language v1 handoff](content/HANDOFF.md) — 29-source
  ...
  validation evidence; Group A ready copy is locally implemented, while
  production content and Group B remain unauthorized.
