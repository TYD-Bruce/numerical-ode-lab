...
export const METHOD_CATALOG: MethodCatalogEntry[] = [
  {
    ...
    blurb: "Explicit first-order method. Its theoretical order is 1 under the method’s usual smoothness and stability assumptions.",
    mode: "first",
  ...
  },
  {
    ...
    blurb: "Implicit first-order method. A-stable for the scalar test equation; each step solves for the next numerical approximation. Absolute stability does not by itself establish accuracy.",
    mode: "first",
    hasOrderSelector: false,
    isImplicit: true,
    orderOfAccuracy: 1,
  ...
  },
  {
    ...
    blurb: "Explicit multistep method; choose the theoretical order p below.",
    mode: "first",
    orderDefault: 2,
    orderMin: 1,
    orderMax: 8,
