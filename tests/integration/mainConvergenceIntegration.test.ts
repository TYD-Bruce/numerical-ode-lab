...
const appSource = readFileSync(
  new URL("../../frontend/src/labs/ode/odeApp.ts", import.meta.url),
  "utf8",
);
const routeSource = readFileSync(
  new URL(
    "../../frontend/src/labs/ode/initialValueProblemsRoute.ts",
    import.meta.url,
  ),
  "utf8"
);
const styles = readFileSync(
  new URL("../../frontend/src/labs/ode/odeApp.css", import.meta.url),
  "utf8",
);
